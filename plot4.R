...
# Plot the first plot which is equal to Plot2
plot(energy[,2], col="black", ylab="Global Active Power (kilowatts)", xaxt="n", type="l", xlab="")
axis(1, at=c(1,1441, 2881), labels=c("Thu", "Fri", "Sat"))

# Plot the second plot which is equal to Plot3
...
# Plot the third plot
plot(energy[,4], col="black", ylab="Voltage", xaxt="n", type="l", xlab="datetime")
axis(1, at=c(1,1441, 2881), labels=c("Thu", "Fri", "Sat"))

# Plot the fourth plot
plot(energy[,3], col="black", ylab="Global_reactive_power", xaxt="n", type="l", xlab="datetime")
axis(1, at=c(1,1441, 2881), labels=c("Thu", "Fri", "Sat"))
